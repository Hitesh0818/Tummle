export const translations = {
  de: {
    ...
    convenient: "Bequem",
    convenientDesc: "Die Jobs kommen zu Dir",
    free: "Kostenlos",
    freeDesc: "Vollständig kostenlos",
    noSpam: "Kein «Job-Spam»",
    noSpamDesc: "Nur perfekte Matches",
    successful: "Hocherfolgreich",
    successfulDesc: "Schnelle Arbeitgeberangebote",
    noMisuse: "Kein Datenmissbrauch",
    noMisuseDesc: "Nur matchende Arbeitgeber erhalten Informationen",
    ...
    seasonalWorkers: "Saisonarbeiter & Ferienjobber",

    // Common
    forEmployers: "Für Arbeitgeber",
    smartMatching: "Smart Matching",
    createProfile: "Profil blitzschnell erstellen",
    autoMatching: "Automatisches Matching mit Arbeitgebern",
    employersContact: "Arbeitgeber kontaktieren dich",
    ...
    bestMatchingRate: "Beste Matching-Rate",
    instantRegistration: "Sofortige Anmeldung",
    alwaysFree: "Immer gratis",
    english: "English",
    german: "Deutsch",
    returningToPrevious: "Kehre zur vorherigen Position zurück...",
  ...
  en: {
    ...
    convenientDesc: "Jobs come to you",
    free: "Free",
    freeDesc: "Completely free",
    noSpam: "No \"Job Spam\"",
    noSpamDesc: "Only perfect matches",
    successful: "Highly successful",
    successfulDesc: "Quick employer offers",
    noMisuse: "No Data Misuse",
    noMisuseDesc: "Only matching employers receive information",
    ...
    smartMatching: "Smart Matching",
    createProfile: "Create profile lightning fast",
    autoMatching: "Automatic matching with employers",
    employersContact: "Employers contact you",
    liveMatches: "Live Matches",
    manyJobs: "Many Jobs",
    topRated: "Top Rated",
    free: "Free",
    ...
    bestMatchingRate: "Best matching rate",
    instantRegistration: "Instant registration",
    alwaysFree: "Always free",
    english: "English",
    german: "Deutsch",
    returningToPrevious: "Returning to previous position...",
    smartTech: "Smart-Tech",
    smartAlgorithm: "Smart Algorithm",
    perfectMatch: "Perfect Match",
    easyFast: "Easy & Fast",
